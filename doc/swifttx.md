...
This mechanism has been integrated into Bitcore-Node-Makeator which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/Makeator-Project/insight-api-makeator#web-socket-api](https://github.com/Makeator-Project/insight-api-makeator#web-socket-api) 
* API: [https://github.com/Makeator-Project/insight-api-makeator#swifttx-transactions](https://github.com/Makeator-Project/insight-api-makeator#swifttx-transactions) 
...
By default, the Makeator Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Makeator Core daemon:
