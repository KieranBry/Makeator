...
In order to support loading of multiple wallets in makeator-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is makeator.cpp.
...
Changes to makeator.cpp
----------------------
makeator.cpp is the entry point into makeator-qt, and as such, will require some minor modifications to provide hooks for
