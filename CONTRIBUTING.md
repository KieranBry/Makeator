Contributing to Makeator Core
============================

The Makeator Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Makeator Core project, and is not to be
confused with overall Makeator Network Protocol consensus changes.

Whether a pull request is merged into Makeator Core rests with the project merge
...
Patches that change Makeator consensus rules are considerably more involved than
...
Where a patch set proposes to change the Makeator consensus, it must have been
...
The project leader is the release manager for each Makeator Core release.
