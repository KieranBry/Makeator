...
SplashScreen::SplashScreen(Qt::WindowFlags f, const NetworkStyle* networkStyle) : QWidget(0, f), curAlignment(0)
{
    ...
    QString titleText = tr("Makeator Core");
    ...
    QString copyrightTextMakeator = QChar(0xA9) + QString(" 2018 ") + QString(tr("The Makeator Core developers"));
    ...
    pixPaint.drawText(paddingLeft, paddingTop + titleCopyrightVSpace + 36, copyrightTextMakeator);
