...
/** Utility functions used by the Makeator Qt UI.
 */
namespace GUIUtil
{
...
// Render Makeator addresses in monospace font
...
// Parse "makeator:" URI into recipient object, return true on successful parsing
