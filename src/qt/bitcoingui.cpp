                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Makeator Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Makeator address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and makeator: URIs)"));
...
/*
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zMKTR"));
...
*/
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Makeator Core"), this);
    aboutAction->setStatusTip(tr("Show information about Makeator Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Makeator"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Makeator addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Makeator addresses"));
    ...
    openAction->setStatusTip(tr("Open a Makeator: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Makeator Core help message to get a list with possible Makeator command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Makeator Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Makeator network", "", count));
}
...
{
    QString strTitle = tr("Makeator Core"); // default title
