 ...
 */
    ...
    typeWidget->addItem(tr("Received Mktr from zMktr"), TransactionFilterProxy::TYPE(TransactionRecord::RecvFromZerocoinSpend));
    ...
    typeWidget->addItem(tr("Zerocoin Spend, Change in zMktr"), TransactionFilterProxy::TYPE(TransactionRecord::ZerocoinSpend_Change_zMktr));
...
void TransactionView::computeSum()
{
    ...
    if (amount < 0) strAmount = "<span style='color: #ee2f77;'>" + strAmount + "</span>";
