...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("Makeator Core"),
     ...
     * override -datadir in the makeator.conf file in the default data directory
     * (to be consistent with makeatord behavior)
     */
    if (dataDir != getDefaultDataDirectory())
