...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Makeator Core makeator-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  makeator-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded makeator transaction") + "\n" +
                               "  makeator-tx [options] -create [commands]   " + _("Create hex-encoded makeator transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded makeator transaction
