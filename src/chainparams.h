...
// Copyright (c) 2018 The Makeator Core developers
 ...
 * Makeator system. There are three: the main network on which people trade goods
...
public:
    ...
    CAmount SwiftTxMinFee() const { return nSwiftTxMinFee; }
