...
#   c) node1 mines 32 blocks, so now node 0 has 60001mktr, node 1 has 4250mktr, node2 has none.
#   d) node0 sends 601 mktr to node2, in two transactions (301 mktr, then 300 mktr).
